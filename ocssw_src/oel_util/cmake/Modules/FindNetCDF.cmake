...
find_path (NETCDF_INCLUDE_DIR netcdf.h
  HINTS ${NETCDF_DIR}/include $ENV{LIB3_DIR}/include)
mark_as_advanced (NETCDF_INCLUDE_DIR)
set (NETCDF_C_INCLUDE_DIRS ${NETCDF_INCLUDE_DIR})

find_library (NETCDF_LIBRARY NAMES netcdf
  HINTS ${NETCDF_DIR}/lib $ENV{LIB3_DIR}/lib)
...
set(netcdf_regex "netcdf-cxx4" "netcdf_c++4")

NetCDF_check_interface (CXX netcdf "${netcdf_regex}")
...
if(NETCDF_FOUND)
  ...
  if(HDF5_FOUND)
    list(APPEND NETCDF_LIBRARIES ${HDF5_C_HL_LIBRARIES} ${HDF5_LIBRARIES})
    list(APPEND NETCDF_INCLUDE_DIRS ${HDF5_INCLUDE_DIRS})
  else()
    set(NETCDF_FOUND FALSE)
    unset(NETCDF_LIBRARIES)
    unset(NETCDF_INCLUDE_DIRS)
  endif()
endif()
