...
/**
 * Wrapper function for sensorName2SensorId
 */
int sensorName2SensorId(std::string name) {
    return sensorName2SensorId(name.c_str());
}
...
/**
 * Wrapper function for instrumentPlatform2SensorId
 */
int instrumentPlatform2SensorId(const std::string &instrument, const std::string &platform) {
    return instrumentPlatform2SensorId(instrument.c_str(), platform.c_str());
}
...
/**
 * Wrapper function for instrumentPlatform2SensorName
 */
std::string instrumentPlatform2SensorName(const std::string &instrument, const std::string &platform) {
    return instrumentPlatform2SensorName(instrument.c_str(), platform.c_str());
}
