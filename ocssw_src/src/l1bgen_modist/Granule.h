...
!Revision History:
   $Log: Granule.h,v $
   Revision 2.8  2011-04-07 14:41:29-04  xgeng
   1. RSB &TEB uncertainty algorithm update; 2. The quadratic RSB RVS changed to 4th order.

   Revision 2.7  2010-11-15 10:19:05-05  xgeng
   Defined a new fill value UNABLE_CALIBRATE_SI (65524); Added a new boolean member Electronic_Anomaly[MAX_NUM_SCANS] to structure QA_Common_t

   Revision 2.5  2009/08/27 14:29:45  xgeng
   Fixed a bug for the Log message


   Revision 6.0.0, December 12, 2007  Razor Issue #216
   ...
   Revision 02.34  October 2, 2002  Razor Issue #166 
   Removed include file "utsname" for use in determining PROCESSINGENVIRONMENT
     (function "getenv" used instead)
   Alice Isaacman, SAIC GSO (Alice.R.Isaacman.1@gsfc.nasa.gov)

   Revision 02.33  August 11, 2002  Razor Issue #166 
   Added include file "utsname" for use in determining PROCESSINGENVIRONMENT
   Alice Isaacman, SAIC GSO (Alice.R.Isaacman.1@gsfc.nasa.gov)
   ...
   Revision 02.30 March 21, 2002  Razor Issue #181
