...
3.BUILD:
 ...
 d.) PCF file notes:
     ...
     MOD02QKM.mcf
     MOD02OBC.mcf
     MOD02_Emissive_LUTs.hdf
     MOD02_QA_LUTs.hdf
     MOD02_Reflective_LUTs.hdf
     ...
     "processed once", otherwise set to "Near Real Time" for NRT processing. 
     Set the value of "ReprocessingPlanned" to "further update is anticipated".
...
14.DELIVERY SIZE:
   Total size of untarred delivery is approximately 3535 MB.
