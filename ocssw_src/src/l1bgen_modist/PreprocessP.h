...
!Revision History:
 $Log: PreprocessP.h,v $
 Revision 1.21  2016-07-22 13:23:32-04  xgeng
 Applied xtalk correction to Terra LWIR PV bands (27-30)

 Revision 1.19  2015-03-13 10:41:19-04  xgeng
 ...
 Revision 1.18  2011-04-07 14:41:30-04  xgeng
 1. RSB &TEB uncertainty algorithm update; 2. The quadratic RSB RVS changed to 4th order.

 Revision 1.17  2010-11-15 10:21:51-05  xgeng
 Defined a new constant (ELECTRONICS_BOTH).

 Revision 1.16  2009/07/24 21:05:29  xgeng
 Added a member "Last_Valid_Scans" to structure L1A_granule_OBCEng_t and Overlap_OBCEng_t to fix the sector rotation abnormal

 Revision 1.15  2008/02/04 16:24:56  ltan
...
#define INVALID_SATELLITE_ID -1
  ...
  PGSt_SMF_status Get_Leading_Gran_Emiss_Coeff
                        (Overlap_OBCEng_t     *Leading_OBCEng,
                         ...
                         float32              Xdn_bb_pvlw_xt[]
                                                [NUM_PVLW_XT_BANDS][DETECTORS_PER_1KM_BAND],
                         float32              *Xb1,
                         int16                *XMS);
