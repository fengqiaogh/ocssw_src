...
!Revision History:
 $Log: Metadata.h,v $
 Revision 1.11  2012-06-26 15:07:53-04  xgeng
 add the doi metadata

 Revision 1.8  2009-08-31 13:40:20-04  xgeng
 Change LOG to Log
 

 Revision 1.6 Janurary 7, 2008  (Razor Issue #216)
 Added deadSubframeDataPercent to L1B_Gran_Metadata_t.
 Xu Geng, SAIC GSO (xu.geng@saic.com)

 Revision 1.5  2006/10/27 15:01:35  ltan
