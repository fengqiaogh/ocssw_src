declare -A all_options=(
  ...
  ['l1cgen_oci']="help= version= par= pversion= verbose= ifile= ofile= l1c_grid= cloud_height= cloud_anc_files= area_weighting= doi= demfile="
  ...
  ['l3bin']="help= version= verbose= dump_options= dump_options_paramfile= dump_options_xmlfile= par= suite= pversion= ifile= ofile= oformat= merged= latnorth= latsouth= loneast= lonwest= sday= eday= deflate= orbit1= orbit2= median= noext= unit_wgt= composite_scheme= composite_prod= reduce_fac= resolve= prod= doi="
...
declare -A option_values=(
  ...
  ['suite']="SST NSST IOP OC KD RRS RRS_SB CLD CLDMASK PAR AOP BGC"
  ...
  ['cirrus_opt']="0 1"
  ['filter_opt']="0 1"
  ["averaging_scheme"]="arithmetic geometric harmonic quadratic"
