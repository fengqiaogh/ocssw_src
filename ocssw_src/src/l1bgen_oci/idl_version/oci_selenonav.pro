  pro oci_selenonav,pos,vel,smat,coef,sunr,pview,npix,delt,xlat,xlon,solz,sola,senz,sena,range,qflag
;
...
;  qflag(*)	byte	 O	Quality flag (1 = off Earth)
;
;	Subprograms Called:
;
...
;
;	Modified for use with selenographic locations
...
;  Check for scan past edge of Moon
