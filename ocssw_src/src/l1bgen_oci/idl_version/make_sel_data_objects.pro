  pro make_sel_data_objects, fid, nscn, ncps

; IDL procedure to create the dimensions and NetCDF data objects for the selenolocation
...
;  Variable specific
  ...
  ncdf_attput, gid, dids(1), "valid_min", -180., /FLOAT
  ncdf_attput, gid, dids(1), "valid_max", 180., /FLOAT
  ...
  ncdf_attput, gid, dids(6), "long_name", "Geolocation pixel quality flags", /CHAR
  ncdf_attput, gid, dids(6), "flag_masks", [1, 2, 4], /BYTE
  ncdf_attput, gid, dids(6), "flag_meanings", "Off_Earth Input_invalid Terrain_bad", /CHAR
