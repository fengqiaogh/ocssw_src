...
#include <stdint.h>
#include <stddef.h>
#include "geolocate_oci.h" // TODO: This should include geo_data not geolocate_oci
#include "device.hpp"
 ...
 * @param numInstrumentBands Number of instrument bands based on aggregation factors
 * @param numL1bBands Number of L1B bands after aggregation
 * @param aggregationOff Indicator for whether instrument aggregation is turned off
