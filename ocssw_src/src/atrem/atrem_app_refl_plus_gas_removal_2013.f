...
C--------1---------2---------3---------4---------5---------6---------7--
      ...
      WRITE(*,*)'           atrem_app_refl_plus_gas_removal_2013'
      WRITE(*,*)'    (atrem for apparent reflectance + gas absorption '
      WRITE(*,*)'     effect removal from imaging spectrometer Data )'
      WRITE(*,*)'                        April 2013'
      WRITE(*,*)'     '
...
C---      CALL SSSSSS
C---      call date_and_time(time=timing(4))
