...
static int32_t terminal_p; /* flag for printing parameters to terminal */
static int32_t terminal_e; /* flag for printing errors to terminal */
static int32_t file_p; /* flag for printing parameters to file */
static int32_t file_e; /* flag for printing errors to terminal */
static FILE *fptr_p;
static FILE *fptr_e;
...
-------------------------*/
int init(ipr, jpr, efile, pfile)

int32_t ipr; /* flag for printing errors (0,1,or 2)		*/
int32_t jpr; /* flag for printing parameters (0,1,or 2)	*/
...
void genrpt_long(A, S) int32_t A;
char *S;
{
    if (terminal_p)
        printf("   %s %d\n", S, A);
