...
/* 0 success, 1 fail; allocates memory and sets n=0 */
int newstringlist(char*** list, int* n, int size);
/* 0 success, 1 fail; frees memory for each string, but not list of strings */
...
/* free variablelist or excludelist. Internally sets *list to NULL. */
