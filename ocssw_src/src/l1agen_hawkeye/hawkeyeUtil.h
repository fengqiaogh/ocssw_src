...
int parseDims( int ncid, int ndims, std::string dimString, int *numDims,
...
int readFrame ( std::ifstream *framefile, uint8_t frame[892], int& prevFrameCnt,
                int ierror[2]);

int getSHpacket( std::ifstream *framefile, uint8_t frame[892], int& framePtr,
